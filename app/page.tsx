      ...
      <header className="p-2 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="btn-neon bg-[#0A1C3A] border-2 border-[#3CA3FF] text-white px-4 py-2 rounded-full flex items-center gap-3 text-base font-semibold"
          >
          ...
          <Button
            ...
            className="btn-neon bg-[#0F5CFF] border-2 border-[#5FA8FF] text-white px-5 py-2 rounded-full flex items-center gap-3 text-base font-bold"
          >
            <div className="btn-neon-content flex items-center gap-3">

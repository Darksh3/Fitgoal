...
export default function QuizPage() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      // Moved body fat question to step 5
      case 5:
        return (
          <div className="space-y-5 sm:space-y-8">
            <div className="text-center space-y-2 sm:space-y-4">

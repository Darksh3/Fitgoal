...
export default function QuizPage() {
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 5: // Renumbered from case 4 - Body fat percentage
      ...
      case 30: // Renumbered from case 29. Training days per week
        // Training days per week is now handled by the slider in case 26.
          ...
          <div className="relative space-y-4 sm:space-y-8">
            ...
            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 max-w-lg mx-auto">
              <div className="relative flex flex-col items-center">
                {/* Body illustration */}
                <div
                  className={`relative w-64 h-auto mb-[-80px] z-10 ${quizData.gender === "mulher" ? "w-52" : "w-48"}`}
                >
                  <img

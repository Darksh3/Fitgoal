      ...
      case 4: // Renamed from 3.5
       ...
       case 5: // Updated from 4
        return (
          <div className="space-y-8">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold text-white">Qual é seu maior problema?</h2>
              <p className="text-gray-300">A nutrição é a chave</p>
            </div>

            <div className="max-w-2xl mx-auto space-y-3">
              {[
                { id: "falta-caloria", label: "Falta de calorias" },
                { id: "muito-caloria", label: "Excesso de calorias" },
                { id: "proteina", label: "Falta de proteína" },
              ].map((option) => (
                <button
                  key={option.id}
                  onClick={() => {
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 px-8 py-4 bg-gray-800 hover:bg-gray-700 text-white rounded-full font-semibold transition-colors"
              >
                Voltar
              </button>
              <button
                ...
                disabled={!canProceed()}
                className="flex-1 h-16 bg-white hover:bg-gray-100 disabled:bg-gray-600 text-black font-bold text-xl rounded-full transition-colors"
              >
                Continuar
              </button>
            </div>

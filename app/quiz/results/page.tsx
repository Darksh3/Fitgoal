          ...
          <div className="mt-8 bg-gray-900 bg-opacity-50 rounded-2xl p-8 border border-gray-700">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-8">
              ...
              <div>
                ...
                <p className="text-white text-xl font-semibold">
                  {getDataValue("calorieGoal") ? Math.round(Number(getDataValue("calorieGoal"))) : (getCaloriesGoal() || "2500")} kcal
                </p>
              </div>
              ...
              <div className="col-span-2">
                ...
                <p className="text-gray-400 text-sm mt-4 text-center">
                  Usamos esses dados para definir volume de treino e ingestão calórica.
                </p>
              </div>

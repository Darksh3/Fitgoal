...
export default function QuizResultsPage() {
  ...
  const getCalorieGoal = () => {
    const targetCalories = getDataValue("targetCalories")
    if (targetCalories) {
    ...
    if (!data) return 2425
    try {
      return calculateNutrition(data?.quizData || data)
    } catch {
      return getDataValue("dailyCalorieGoal") || getDataValue("calorieGoal") || 2425
    }
  }

  const triggerBarAnimation = (barId: string) => {
    setAnimatedBars((prev) => new Set([...prev, barId]))
  }
  ...
  return (
    <main className="min-h-screen bg-black pt-12 pb-20">
      ...
      >
        ...
        <div className="rounded-lg border border-gray-800 bg-gray-900 p-8 mb-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <motion.div
                    ...
                    initial="hidden"
                    animate={animatedBars.has("currentBodyFat") ? "visible" : "hidden"}
                  >
                    <div
                ...
                <div>
                  ...
                  <motion.div
                    ...
                    variants={progressBarVariants}
                    initial="hidden"
                    animate={animatedBars.has("currentTrainingLevel") ? "visible" : "hidden"}
                  >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <motion.div
                    ...
                    variants={progressBarVariants}
                    initial="hidden"
                    animate={animatedBars.has("targetBodyFat") ? "visible" : "hidden"}
                  >
                ...
                <div>
                  ...
                  <motion.div
                    ...
                    variants={progressBarVariants}
                    initial="hidden"
                    animate={animatedBars.has("targetTrainingLevel") ? "visible" : "hidden"}
                  >
        ...
        <motion.div
          variants={itemVariants}
          className="relative z-10 -mt-20 rounded-lg border border-gray-800 bg-gray-900 bg-opacity-90 p-8"
        >
          <div className="grid grid-cols-2 gap-x-8 gap-y-8">
            {/* Left column - Current stats */}
            <div>
              <div className="mb-4">
                <p className="text-sm text-gray-400 mb-2">Percentual de Gordura</p>
                <p className="text-2xl font-bold text-white">{getDataValue("bodyFat") || "—"}%</p>
              </div>
              <motion.div
                key="current-bodyfat"
                variants={progressBarVariants}
                ...
                whileInView="visible"
                viewport={{ once: true }}
                onAnimationComplete={() => triggerBarAnimation("current-bodyfat")}
                style={{ transformOrigin: "left" }}
                className="h-1.5 bg-gradient-to-r from-orange-500 to-orange-600 rounded mb-6"
              />

              <div className="mb-4">
                <p className="text-sm text-gray-400 mb-2">Nível de Treino</p>
                <p className="text-xl font-bold text-white">
                  {getDataValue("trainingLevel") === "beginner" ? "Iniciante" : "Avançado"}
                </p>
              </div>
              <motion.div
                key="current-level"
                ...
                style={{ transformOrigin: "left" }}
                className="h-1.5 bg-gradient-to-r from-orange-500 to-orange-600 rounded"
              />
            </div>
            ...
            <div>
              <div className="mb-4">
                <p className="text-sm text-gray-400 mb-2">Percentual de Gordura</p>
                <p className="text-2xl font-bold text-lime-400">{getDataValue("targetBodyFat") || "—"}%</p>
              </div>
              <motion.div
                key="target-bodyfat"
                variants={progressBarVariants}
                ...
                style={{ transformOrigin: "left" }}
                className="h-1.5 bg-gradient-to-r from-lime-400 to-lime-500 rounded mb-6"
              />

              <div className="mb-4">
                <p className="text-sm text-gray-400 mb-2">Nível de Treino</p>
                <p className="text-xl font-bold text-lime-400">
                  {getDataValue("targetTrainingLevel") === "beginner" ? "Iniciante" : "Avançado"}
                </p>
              </div>
              <motion.div
                key="target-level"
                ...
                style={{ transformOrigin: "left" }}
                className="h-1.5 bg-gradient-to-r from-lime-400 to-lime-500 rounded"
              />
            </div>
          </div>
        </motion.div>
      ...
      >
        ...
        <motion.div
          variants={itemVariants}
          className="rounded-lg border border-gray-800 bg-gray-900 bg-opacity-50 p-8 mb-12"
        >
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-8">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              onAnimationComplete={() => triggerBarAnimation("gender")}
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              onAnimationComplete={() => triggerBarAnimation("age")}
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              onAnimationComplete={() => triggerBarAnimation("height")}
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              onAnimationComplete={() => triggerBarAnimation("currentWeight")}
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              onAnimationComplete={() => triggerBarAnimation("imc")}
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              onAnimationComplete={() => triggerBarAnimation("calorieGoal")}
            >
              <p className="text-gray-400 text-sm mb-2">Meta de Calorias</p>
              <p className="text-white text-xl font-semibold">{getCalorieGoal()} kcal</p>
            </motion.div>
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              onAnimationComplete={() => triggerBarAnimation("targetDate")}
            >
        ...
        <div className="mt-20 py-16 border-t border-gray-800">
          ...
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                <svg className="w-6 h-6 text-gray-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9 3a1 1 0 011 1v1a1 1 0 11-2 0V4a1 1 0 011-1zM5.05 6.051a1 1 0 00-1.414 1.414l.707.707a1 1 0 101.414-1.414l-.707-.707zM3 9a1 1 0 100 2v4a2 2 0 000 4h12a2 2 0 000-4V9a1 1 0 100-2H3z"></path>
                </svg>
                <div>
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-gray-900 rounded-2xl overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <p className="text-gray-400 text-sm line-clamp-3">
                    Os vídeos são muito úteis e fáceis de entender. Os conselhos do seu consultor funcionam bem comigo.
                    Consigo dormir cedo agora. Este aplicativo funciona f...
                  </p>
                  <button className="text-orange-400 text-sm font-semibold hover:text-orange-300">Ler mais</button>
                </div>
              </div>
            ...
            <p className="text-xs text-gray-500 text-center">
              *Disclaimer: Usuários do BetterMe compartilharam seu feedback. Este usuário teve acesso a treinamento
              ...
              jornada de fitness e resultados geralmente aparecem em 4 semanas. Os resultados podem variar por pessoa e
              não são garantidos.
            </p>
          </div>
        </section>
            ...
            <div className="space-y-6">
              ...
              <details className="group border border-gray-700 rounded-lg p-6 cursor-pointer hover:border-gray-600 transition">
                ...
                <p className="text-gray-400 mt-4">
                  Nosso plano foi desenvolvido para ajudá-lo a queimar gordura e construir um corpo tonificado e magro,
                  combinando treinos passo a passo com um plano de refeições personalizado. Nossas rotinas com vídeos
                  guiados garantem a forma correta e ajudam você a manter a consistência e a motivação, tornando a perda
                  de peso mais alcançável e sustentável.
                </p>
              </details>

        ...
        <div className="max-w-5xl mx-auto mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                    selectedPlan === "monthly" ? "border-orange-400 bg-orange-400" : "border-gray-600"
                  }`}
                >
                  {selectedPlan === "monthly" && (
              ...
              <p className="text-gray-400 text-sm mb-3">Acesso completo por 30 dias</p>
            ...
            <div
              ...
              className={`rounded-lg p-6 cursor-pointer transition-all relative ${
                selectedPlan === "quarterly"
                  ? "bg-gray-900 border-2 border-orange-400"
                  : "bg-gray-900 border-2 border-orange-400"
              }`}
            >
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-orange-400 text-black text-xs font-bold px-4 py-1 rounded-full">
                MAIS POPULAR
              </div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-white">Plano Trimestral</h3>
                <div className="w-6 h-6 rounded-full border-2 border-orange-400 bg-orange-400 flex items-center justify-center">
                  <svg className="w-4 h-4 text-black" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
                  </svg>
                </div>
              </div>
              <p className="text-gray-400 text-sm mb-3">Acesso completo por 90 dias</p>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                    selectedPlan === "semiannual" ? "border-orange-400 bg-orange-400" : "border-gray-600"
                  }`}
                >
                  {selectedPlan === "semiannual" && (
                    <svg className="w-4 h-4 text-black" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-400 text-sm mb-3">Acesso completo por 180 dias</p>

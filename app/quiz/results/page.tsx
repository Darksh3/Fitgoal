...
export default function QuizResultsPage() {
  ...
  const handlePlanSelection = (plan: "monthly" | "quarterly" | "semiannual") => {
  ...
  const handleCheckout = () => {
    ...
    router.push(`/checkout?plan=${planMap[selectedPlan]}`)
  }
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white">
      ...
      <main className="w-full px-6 py-12">
        ...
        {/* First section - "Escolha Seu Plano" */}
        <section className="w-full bg-black py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-white text-center mb-12">Escolha Seu Plano</h2>

            {/* Promo Banner */}
            <div className="bg-orange-500 rounded-full px-6 py-3 inline-flex items-center justify-center w-full mb-8">
              <span className="text-white font-semibold">Código Promo Aplicado!</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                      selectedPlan === "monthly" ? "border-orange-500 bg-orange-500" : "border-gray-500"
                    }`}
                  >
                    {selectedPlan === "monthly" && <span className="text-white text-sm">✓</span>}
                  </div>
                </div>
                <p className="text-gray-400 text-sm mb-4">Acesso completo por 30 dias</p>
                <p className="text-3xl font-bold text-white mb-1">R$ 79,90</p>
              ...
              <div
                ...
                className={`p-6 rounded-lg cursor-pointer transition-all relative ${
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4 mt-4">
                  ...
                  <div
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                      selectedPlan === "quarterly" ? "border-orange-500 bg-orange-500" : "border-gray-500"
                    }`}
                  >
                    {selectedPlan === "quarterly" && <span className="text-white text-sm">✓</span>}
                  </div>
                </div>
                <p className="text-gray-400 text-sm mb-4">Acesso completo por 90 dias</p>
                <p className="text-3xl font-bold text-white mb-1">R$ 159,90</p>
                <p className="text-gray-400 text-sm">por trimestre</p>
              </div>
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                      selectedPlan === "semiannual" ? "border-orange-500 bg-orange-500" : "border-gray-500"
                    }`}
                  >
                    {selectedPlan === "semiannual" && <span className="text-white text-sm">✓</span>}
                  </div>
                </div>
                <p className="text-gray-400 text-sm mb-4">Acesso completo por 180 dias</p>
                <p className="text-3xl font-bold text-white mb-1">R$ 239,90</p>
                <p className="text-gray-400 text-sm">por semestre</p>
              </div>
            </div>
            ...
            <div className="flex justify-center">
              <button
                ...
                className="bg-white text-black px-12 py-3 rounded-full font-bold hover:bg-gray-200 transition"
              >
                OBTER MEU PLANO
              </button>
            </div>
        ...
        {/* Second section - "Obtenha resultados visíveis" (replicate the same) */}
        <section className="w-full bg-black py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">

...
export default function SuccessPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] bg-gradient-to-b from-[#050B1A] via-[#07112A] to-[#050B1A] p-4">
      <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-[0_10px_30px_rgba(0,0,0,0.35)] text-center max-w-md w-full"
        {status === "loading" && (
          <>

...
import { trackTikTokEvent } from "@/lib/pixels"
...
export default function SuccessPage() {
  ...
  // Helper: dispara Purchase no Meta + TikTok sempre juntos
  const firePurchasePixels = (value: number, planName: string, eventId?: string) => {
        ...
        // TikTok Pixel (client-side) — sempre junto com o Meta
        trackTikTokEvent("CompletePayment", {
                content_id: "fitgoal_plano",
                ...
                if (embedded === "true") {
                  ...
                  try {
                            ...
                            if (response.ok) {
                                ...
                                setStatus("success")
                                          firePurchasePixels(59.90, "Plano FitGoal", `purchase_${userId}`)
                            }
                  } catch (error: any) {

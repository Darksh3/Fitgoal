              ...
              <div className="p-6 border-b border-slate-800 flex items-center justify-between">
                      <Link href="/admin" className="flex items-center gap-2">
                                <div className="w-10 h-10 bg-gradient-to-br from-lime-400 to-lime-600 rounded-lg flex items-center justify-center">
                                            <span className="text-slate-900 font-bold text-lg">F</span>span>
                                </div>div>
                                <div>
                                            <h1 className="text-lg font-bold text-white">Fitgoal</h1>h1>
                                            <p className="text-xs text-slate-400">Admin</p>p>
                                </div>div>
                      </Link>Link>

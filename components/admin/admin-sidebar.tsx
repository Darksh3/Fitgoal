...
import { BarChart3, Users, Zap, TrendingUp, Settings, Wallet, ListTodo, X, Layers, Lightbulb, MessageSquare, Gift } from "lucide-react"
...
const navItems = [
  ...
  { label: "Planos", href: "/admin/plans", icon: ListTodo },
  { label: "Trial Gratuito", href: "/admin/trial", icon: Gift },
  { label: "Funil", href: "/admin/funnel", icon: TrendingUp },
  { label: "Quiz Analytics", href: "/admin/quiz-analytics", icon: BarChart3 },
  { label: "Segmentos", href: "/admin/segments", icon: ListTodo },
  { label: "Quiz Builder", href: "/admin/quiz-builder", icon: Layers },
  { label: "Prompt Studio", href: "/admin/prompt-studio", icon: Lightbulb },
